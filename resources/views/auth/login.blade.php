...
@section('title', 'Sign In - Form Generator')
        ...
        <div class="w-full max-w-md">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="email" name="email" type="email" value="{{ old('email') }}" required
                            autofocus autocomplete="username" placeholder="your@email.com"
                    ...
                    <div class="flex items-center">
                        <input id="remember" name="remember" type="checkbox"
                            class="w-4 h-4 border-neutral-300 dark:border-neutral-700 rounded focus:ring-2 focus:ring-neutral-900 dark:focus:ring-neutral-100" />
            ...
            <div class="text-center mt-8">
                <p class="text-sm text-neutral-600 dark:text-neutral-400 font-light">
                    ...
                    <a href="{{ route('register') }}" class="font-medium hover:underline transition">
                        Sign up
                    </a>
                </p>
            </div>
